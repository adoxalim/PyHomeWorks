...
def totalDays(birthDay,birthMonth,birthYear):
    fullBirthDay=currentTime()
    return ((fullBirthDay[0]-birthDay)+(fullBirthDay[1]-birthMonth) * 30 + (fullBirthDay[2]-birthYear)*365)
...
print("The person has been living for ", totalhours ," hours.")
